...
<body>
	...
	<div class="container content-section">
	    <div class="row align-items-center mt-5">
	        ...
	        <div class="col-12 col-md-6 content-text d-flex flex-column justify-content-center text-center text-md-left mb-4 mb-md-0">
	            <h1 class="mb-5">Welcome To Shopix...</h1>
	            <h3>Discover the Best Products</h3>
	            <p>At Shopix, we offer a wide range of products at unbeatable prices. Whether you're looking to buy or sell, we've got you covered!</p>
    ...
    <div class="container card-section">
        ...
        <h2 class="text-center w-100 my-5">Why Retailers Should Register on Shopix</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>Registering on Shopix allows retailers to reach a large and diverse customer base. Expand your business by showcasing your products to millions of customers.</p>
            </div>
        </div>
